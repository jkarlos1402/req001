...
if (mysql_num_rows($resultado) == 0) {
    ...
    echo '<form id="formModificaCli" method="post" action="../cliente/modificaCliente.php" target="_top">
            <div id="accordion">
    ...
    echo '              <tr>
                            ...
                            <td>
                                <input name="TelEntCli" type="text" id="TelEntCli"  disabled value=' . $row['TelEntCli'] . ' class="requerido" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div>
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <input name="Nom1CtoCli" type="text" id="Nom1CtoCli" size="50" disabled value="' . $row['Nom1CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Dir1CtoCli" type="text" id="Dir1CtoCli" size="50" disabled value="' . $row['Dir1CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Tel1CtoCli" type="text" id="Tel1CtoCli" size="10" disabled value="' . $row['Tel1CtoCli'] . '"/>
                                <label>Ext:</label>
                ...
                <div>
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <input name="Nom2CtoCli" type="text" id="Nom2CtoCli" size="50" disabled value="' . $row['Nom2CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Dir2CtoCli" type="text" id="Dir2CtoCli" size="50"  disabled value="' . $row['Dir2CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Tel2CtoCli" type="text" id="Tel2CtoCli" size="10" disabled value="' . $row['Tel2CtoCli'] . '"/>
                                <label>Ext:</label>
                ...
                <div>
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <input name="Nom3CtoCli" type="text" id="Nom3CtoCli" size="50" disabled value="' . $row['Nom3CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Dir3CtoCli" type="text" id="Dir3CtoCli" size="50" disabled value="' . $row['Dir3CtoCli'] . '"/>	
                            </td>
                            <td>
                                <input name="Tel3CtoCli" type="text" id="Tel3CtoCli" size="10" disabled value="' . $row['Tel3CtoCli'] . '"/>
                            <label>Ext:</label>
