...
if (mysql_num_rows($res) == 0)
	...
	{
$perfiles = '<label>Proyecto: </label><select required name="IdEntPry" id="IdEntPry" onchange="mostrarInfoIng(this.value)"><option value="0">Selecciona un proyecto</option>';
