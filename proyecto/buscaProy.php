...
<tr>
    ...
    <td><label for="ltxt_fecFin">Fecha final</label>
  ...
  $("#ltxt_fecFin").datepicker("setDate","'.$ltxt_fecTerPry.'");</script>  
 </td>
</tr>
<tr>
<td colspan="3">
...
<td>
  ...
  <input type="text" name="lint_pjeUni" title="Porcentaje asignado a la UAEMéx" id="lint_pjeUni" value="'.$proyecto['PjeEntPry'].'" size="3"/>%</td>
</tr>
</table>
</div>
<h3>
...
<td>'.($contFase+1).'<input type="hidden" id="IdEntEtr'.$contFase.'" name="IdEntEtr'.$contFase.'" value="'.$fase['IdEntEtr'].'"/></td>
<td><input type="text" id="ltxt_ctoFas'.$contFase.'" name="ltxt_ctoFas'.$contFase.'" size="60" value="'.$fase['CtoEntEtr'].'"/></td>
<td><input type="fechaEtr" id="ltxt_fecEnt'.$contFase.'" name="ltxt_fecEnt'.$contFase.'" value="'.$fase['FecPrgEtr'].'"/>
<script type="text/javascript">
  ...
  $formulario.= '$("#ltxt_fecEnt'.$contFase.'").datepicker("setDate","'.$ltxt_fecPrgEtr.'");</script>
</td>';
if($contFase > 1){
...
$formulario .='</tr><script type="text/javascript">
...
<td>'.($contPago+1).'<input type="hidden" id="IdEntPag'.$contPago.'" name="IdEntPag'.$contPago.'" value="'.$pago['IdEntPag'].'" '.$disabled.'/></td>
<td><input type="text" name="ltxt_ctoPag'.$contPago.'" id="ltxt_ctoPag'.$contPago.'" size="50"  value="'.$pago['CtoEntPag'].'" '.$disabled.'/></td>
...
if($contPago>0 && $pago['FecEntPagRal'] == ""){
	$formulario.='<script type="text/javascript">$("#botonP'.($contPago-1).'").html("");</script><td id="botonP'.$contPago.'"><a href="#" id="quitaPago" style="height: 20px;"></a></td><script type="text/javascript">$("#quitaPago").button({icons: {primary: "ui-icon-trash"}});
		$("#quitaPago").on("click",function(click,ui){quitarPago('.($numPagos-1).');});</script>';
}
$formulario.='</tr>';
	$contPago++;
}
...
valida("pje",'.($numPagos-1).');</script><tr>
