...
//Consulta 2 para obtener los resultados de sus cuentas bancarias y los datos del banco y sucursal 
	...
	if (mysql_num_rows($resultado) == 0)
	{
		...
		echo'<form action="../participante/modificaParticipante.php" method="post" name="formAddPoE" id="formAddPoE" target="_top">
...
echo '<tr  id="cuentas'.$i.'" class="entrada'.($i%2).'">
  ...
  if($i>0)
  	echo '<a href="#" id="quitaCuenta">Eliminar</a>
		  ...
		  $("#quitaCuenta").on("click",function(click,ui){quitarCuenta('.$i.');});</script>';
  echo'</td>
   </tr>';
   $i++;
 }
